        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    PowerShell Empire Web utilizes the <a href="https://github.com/PowerShellEmpire/Empire/wiki/RESTful-API">Empire REST API Server</a>. It is a web interface for using <a href="https://github.com/PowerShellEmpire/Empire/">PowerShell Empire</a>.<br><br>
